...
namespace WinFormsSchool
{
    public partial class SchoolArticleSearchForm : Form
    {
        ...
        private void SchoolArticleSearchForm_Load(object sender, EventArgs e)
        {
        ...
        {
            var success = int.TryParse(gridViewArticles.SelectedRows[0].Cells[0].Value.ToString(),out int selectedId);
