...
namespace WinFormsSchool
{
    public partial class TeacherSearchForm : Form
    {
        ...
        readonly AppCode.BLL.TeacherBLL Teacher;
        ...
        public TeacherSearchForm()
        {
            InitializeComponent();
            InitializeControls();
            Teacher = new AppCode.BLL.TeacherBLL();
        }
            ...
            if (textBoxSearch.Text.Length >= MinimumCharactersSearchCommand)
            {
                ...
                if(searchTeachters is not null)
                {
                    ...
                    if (searchTeachters.Count > 0)
                    {
                        ...
                        if (searchTeachters.Count > 1) { labelTeachersFound.Text += " teachers found"; }
                        else { labelTeachersFound.Text += " teacher found"; }
                    }
                    else
                    {
